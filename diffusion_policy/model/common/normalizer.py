...
class LinearNormalizer(DictOfTensorMixin):
    """
    Scale data to consistent ranges.

    In "limits" mode, the data is scaled to the range [output_min, output_max]:
        scale = (output_max - output_min) / (input_max - input_min)
        offset = output_min - scale * input_min
        normalized = original * scale + offset
    In "gaussian" mode, the data is scaled to have mean 0 and std 1:
        normalized = (original - mean) / std

    This is really just a dictionary of SingleFieldLinearNormalizer. A separate
    SingleFieldLinearNormalizer is created for each key in the dictionary, and
    retrieved via the `__getitem__` method.
    """
    ...
    def fit(
        ...
        """
        Fit the normalizer to the data, i.e. learns the normalization parameters
        from the data.
        """
    ...
    def fit_from_input_stats(
        ...
        **kwargs,
        ...
        """
        Simply retrieve the normalization parameters from input stats.
        """
    ...
    def __getitem__(self, key: str):
        """
        Retrieve the SingleFieldLinearNormalizer for the given key.
        """
    ...
    def _normalize_impl(self, x, forward=True):
        """
        Handle dictionary and single tensor inputs.
        """
